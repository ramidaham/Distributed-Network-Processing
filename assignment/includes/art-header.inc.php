			...
			<nav class="navbar navbar-default" role="navigation">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					<ul class="nav navbar-nav">
						...
						<li><a href="display-art-work.php?ArtWorkID=<?php echo $artwork_row['ArtWorkID'] ?>">Art Works</a></li>
						<li><a href="display-artist.php?id=<?php echo $artist_row['ArtistID'] ?>">Artists</a></li>
						<li class="dropdown">
